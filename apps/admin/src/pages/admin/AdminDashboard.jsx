    ...
    return (
        <>
            ...
            <div className='space-y-6'>
                {/* Welcome Section */}
                <div className='rounded-xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] transition-colors hover:border-gray-300 dark:hover:border-gray-700'>
