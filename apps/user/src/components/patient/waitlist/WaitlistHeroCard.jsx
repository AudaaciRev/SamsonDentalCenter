...
const WaitlistHeroCard = ({ heroEntry, stats }) => {
    ...
    if (isEmpty) {
        return (
            <div className="w-full px-4 sm:px-0 mt-2 mb-2 sm:mt-0 sm:mb-6">
                ...
                <div className="bg-white dark:bg-white/[0.03] border border-gray-100 dark:border-gray-800 rounded-xl p-6 flex flex-col items-center text-center">
                    <div className="w-12 h-12 bg-gray-50 dark:bg-white/5 rounded-lg flex items-center justify-center text-gray-400 mb-3">
                        <Inbox size={24} />
                    </div>
    ...
    if (hasOffer) {
        return (
            <div className="w-full px-4 sm:px-0 mt-2 mb-2 sm:mt-0 sm:mb-6">
                ...
                <div className="bg-gradient-to-br from-indigo-600 to-violet-700 rounded-xl p-5 text-white relative overflow-hidden">
                    {/* Decorative Elements */}
                    <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -mr-16 -mt-16 blur-2xl" />
                    
                    <div className="relative flex items-center justify-between gap-4">
                        <div className="flex items-center gap-4">
                            <div className="w-12 h-12 sm:w-14 sm:h-14 bg-white/20 backdrop-blur-md rounded-lg flex items-center justify-center">
                        ...
                        <button 
                            ...
                            className="bg-white text-indigo-600 px-5 py-3 rounded-lg text-xs font-black flex items-center gap-2 hover:bg-gray-50 transition-colors"
                        >
                            Claim Now
                            <ArrowRight size={14} />
                        </button>
    ...
    return (
        <div className="w-full px-4 sm:px-0 mt-2 mb-2 sm:mt-0 sm:mb-6">
            ...
            <div className="bg-white dark:bg-white/[0.03] border border-gray-100 dark:border-gray-800 rounded-xl p-5 flex items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                    <div className="w-12 h-12 sm:w-14 sm:h-14 bg-amber-50 dark:bg-amber-500/10 rounded-lg flex items-center justify-center text-amber-600">
                ...
                <button 
                    disabled
                    className="bg-gray-50 dark:bg-gray-700 text-gray-400 px-4 py-2.5 rounded-lg text-[10px] font-black flex items-center gap-2 transition-all cursor-not-allowed uppercase tracking-widest"
                >
                    <Bell size={14} />
                    Enable Alerts
                </button>
